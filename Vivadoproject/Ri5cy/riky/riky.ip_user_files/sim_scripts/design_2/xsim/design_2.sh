...
#
# Script generated by Vivado on Wed Jan 21 14:26:46 +0100 2026
...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L smartconnect_v1_0 -L xilinx_vip"
...
# script info
echo -e "design_2.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_bram_ctrl_v4_1_13 -L blk_mem_gen_v8_4_12 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_36 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L xlconstant_v1_1_10 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_2 xil_defaultlib.design_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_2 -key {Behavioral:sim_1:Functional:design_2} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/bd_ebcc.protoinst" -protoinst "protoinst_files/design_2.protoinst" -log simulate.log
}
...
Usage: design_2.sh [-rerun]\n\
Usage: design_2.sh [-reset_run]\n\
Usage: design_2.sh [-clean]\n\
