...
#
# Script generated by Vivado on Tue Nov 25 09:03:36 +0100 2025
...
simulate()
{
  xsim design_2 -key {Behavioral:sim_1:Functional:design_2} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_074c.protoinst" -protoinst "protoinst_files/design_2.protoinst" -log simulate.log
}
