...
#ifndef _design_1_microblaze_riscv_0_xlconcat_1_core_h_
#define _design_1_microblaze_riscv_0_xlconcat_1_core_h_
...
class design_1_microblaze_riscv_0_xlconcat_1_core : public sc_module 
{
    public: 
       design_1_microblaze_riscv_0_xlconcat_1_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(design_1_microblaze_riscv_0_xlconcat_1_core);
        SC_METHOD(concate_input_port_values);
            sensitive << In0 ;
        dont_initialize();
    }

    virtual ~design_1_microblaze_riscv_0_xlconcat_1_core() = default;
