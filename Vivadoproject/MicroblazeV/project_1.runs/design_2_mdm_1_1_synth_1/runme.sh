...
HD_PWD='C:/Users/MahmoudHc/Desktop/ptech/Projet/project_1/project_1.runs/design_2_mdm_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_mdm_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_mdm_1_1.tcl
